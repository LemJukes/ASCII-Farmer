...
@onready var ToolHoeButton: Button = $Window_PanelContainer/MarginContainer/VBoxContainer/MainContent_PanelContainer/VBoxContainer/HandTools_MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer/ToolHoe_Button
@onready var ToolSeedBagButton: Button = $Window_PanelContainer/MarginContainer/VBoxContainer/MainContent_PanelContainer/VBoxContainer/HandTools_MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer/ToolSeedBag_Button
@onready var ToolWateringCanButton: Button = $Window_PanelContainer/MarginContainer/VBoxContainer/MainContent_PanelContainer/VBoxContainer/HandTools_MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer/ToolWateringCan_Button
@onready var ToolSickleButton: Button = $Window_PanelContainer/MarginContainer/VBoxContainer/MainContent_PanelContainer/VBoxContainer/HandTools_MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer/ToolSickle_Button
...
func _Setup() -> void:
	CurrentToolValueLabel.text = VarStor.TOOL_NONE
